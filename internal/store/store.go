...
// refreshLoadedCases rebuilds derived projections after a restart so snapshots
// written by older versions do not leave query fields stale in memory.
func refreshLoadedCases(cases map[string]*domain.ProvenanceCase) {
